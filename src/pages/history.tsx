...
// Historyという名前の関数コンポーネントを作り、他の場所でも使えるようにしてる
// export：他のファイルから使えるようにエクスポート（公開）している
// React.FC：HistoryはReactの関数コンポーネントという意味
export const History: React.FC<Props> = (props) => {
  ...
  // 第一引数に実行したい関数、第二引数に変更を管理する状態の配列を渡す
  // 第二引数の配列は更新されると、第一引数に渡した関数が実行される
  useEffect(() => {
